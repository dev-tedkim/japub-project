...
public class CommentController {
	...
	public ResponseEntity<List<CommentDto>> getList(@PathVariable Long boardNum, Criteria criteria) {
	...
	public ResponseEntity<String> insert(@RequestBody CommentDto commentDto, @PathVariable Long boardNum, HttpSession session) {
