	...
	<main class="main">
	    <div class="writeContainer">
	      <section>
	        <span>게시글수정</span>
	        <div class="buttonBox">
	          <a href="<c:url value='/board/detail${criteria.params}&boardNum=${board.boardNum}' />"><i class="fa fa-bars"></i> 취소</a>
	          <a class="updateBoardBtn" data-formname="updateForm"><i class="fa fa-pencil"></i> 수정</a>
	        </div>
	      </section>
	      <form name="registerForm" class="updateForm" method="post" autocomplete="off">
